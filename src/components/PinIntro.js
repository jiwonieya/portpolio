...
const PinIntro = () => {
  ...
  return (
    <div className="pin-container">
      ...
      <section className="pin-overview" ref={overviewRef}>
        <PinOverview />
      </section>
      <section className="pin-ds" ref={dsRef}>
        <PinDS />
      </section>
      <section className="pin-uf" ref={ufRef}>
        <PinUF />
      </section>
      <section className="pin-rwd" ref={rwdRef}>
        <PinRWD />
      </section>
      <section className="pin-ending" ref={endingRef}>
        <PinEnding />
      </section>
    </div>
  );
