...
const RirimIntro = () => {
    ...
    return (
        <div className="ririm-container">
            ...
            <section className="ririm-wrapper" ref={wrapperRef}>
                ...
                <div className="ririm-txt">
                    ...
                    <p className="ririm-ment">
                        감정 공감과 자기표현, 꾸미기를 좋아하는 10~20대 소비자들의 트렌드를 담아, <br /> 직접 고르고 즐길 수 있는 테마형 문구 쇼핑몰 제작
                    </p>
                </div>
            ...
            <section className="ririm-overview" ref={overviewRef}><RirimOverview /></section>
            <section className="ririm-ds" ref={dsRef}><RirimDS /></section>
            <section className="ririm-uf" ref={ufRef}><RirimUF /></section>
            <section className="ririm-rwd" ref={rwdRef}><RirimRWD /></section>
            <section className="ririm-ending" ref={endingRef}><RirimEnding /></section>
        </div>
    );
};
